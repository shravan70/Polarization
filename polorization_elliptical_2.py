...
def calculate_elliptical_polarization(frame):
    ...
    B_z = amplitude_z * np.sin(k * x - omega * t)  # Minor axis component for B
    B_y = -amplitude_y * np.sin(k * x - omega * t + phase_difference)  # Major axis component with phase difference
